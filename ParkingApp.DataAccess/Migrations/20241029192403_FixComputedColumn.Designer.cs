...
namespace ParkingApp.DataAccess.Migrations
{
    ...
    [Migration("20241029192403_FixComputedColumn")]
    partial class FixComputedColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ParkingApp.DataAccess.Entities.LicensePlate", b =>
                {
                    ...
                    b.Property<string>("FullLicensePlate")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("[CityCode] +' ' + [ProvienceCode] + ' ' +[RegistrationYear]+CONVERT (nvarchar(50),[Id])", true);
